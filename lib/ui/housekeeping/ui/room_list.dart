...
class _RoomListState extends State<RoomList> {
  ...
  ScaffoldMessenger buildScaffoldMessenger(
      BuildContext context, FloorsModel model) {
              ...
              child: Container(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    bool hasFloorsForCleaning = model
                        .hasRoomsForCleaning(model.floorList[index].toString());
                    return Padding(
                        ...
                        child: ElevatedButton(
                          style: ButtonStyle(
                            ...
                            backgroundColor: MaterialStateProperty.all<Color>(
                                int.parse(model.selectedFloor.number) - 1 ==
                                        index
                                    ? Colors.blue
                                    : Colors.white),
